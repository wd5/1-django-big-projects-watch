...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebSource.date'
        db.add_column('big_projects_watch_websource', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 9, 3, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebSource.date'
        db.delete_column('big_projects_watch_websource', 'date')
