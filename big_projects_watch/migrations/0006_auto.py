...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('big_projects_watch_project_former_responsible_participants', (
        ...
        db.create_unique('big_projects_watch_project_former_responsible_participants', ['project_id', 'participant_id'])


    def backwards(self, orm):
        # Removing M2M table for field former_responsible_participants on 'Project'
        db.delete_table('big_projects_watch_project_former_responsible_participants')
