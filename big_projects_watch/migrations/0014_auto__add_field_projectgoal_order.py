...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectGoal.order'
        db.add_column('big_projects_watch_projectgoal', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectGoal.order'
        db.delete_column('big_projects_watch_projectgoal', 'order')
