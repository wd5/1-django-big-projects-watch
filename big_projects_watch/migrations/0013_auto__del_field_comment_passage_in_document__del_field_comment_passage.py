...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comment.passage_in_document'
        db.delete_column('big_projects_watch_comment', 'passage_in_document')

        # Deleting field 'Comment.passage_start_page'
        db.delete_column('big_projects_watch_comment', 'passage_start_page')

        # Adding field 'Comment.page'
        db.add_column('big_projects_watch_comment', 'page',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DocumentRelation.passage_start_page'
        db.delete_column('big_projects_watch_documentrelation', 'passage_start_page')

        # Deleting field 'DocumentRelation.passage_in_document'
        db.delete_column('big_projects_watch_documentrelation', 'passage_in_document')

        # Adding field 'DocumentRelation.page'
        db.add_column('big_projects_watch_documentrelation', 'page',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Comment.passage_in_document'
        db.add_column('big_projects_watch_comment', 'passage_in_document',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Comment.passage_start_page'
        db.add_column('big_projects_watch_comment', 'passage_start_page',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Comment.page'
        db.delete_column('big_projects_watch_comment', 'page')

        # Adding field 'DocumentRelation.passage_start_page'
        db.add_column('big_projects_watch_documentrelation', 'passage_start_page',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DocumentRelation.passage_in_document'
        db.add_column('big_projects_watch_documentrelation', 'passage_in_document',
                      self.gf('django.db.models.fields.CharField')(default='Seite x', max_length=250),
                      keep_default=False)

        # Deleting field 'DocumentRelation.page'
        db.delete_column('big_projects_watch_documentrelation', 'page')
