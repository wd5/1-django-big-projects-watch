...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('big_projects_watch_project', 'desc_information_sources', 'desc_documents')

    def backwards(self, orm):
        db.rename_column('big_projects_watch_project', 'desc_documents', 'desc_information_sources')
