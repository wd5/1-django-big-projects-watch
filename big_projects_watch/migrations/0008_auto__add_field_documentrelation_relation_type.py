...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentRelation.relation_type'
        db.add_column('big_projects_watch_documentrelation', 'relation_type',
                      self.gf('django.db.models.fields.CharField')(default='C', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentRelation.relation_type'
        db.delete_column('big_projects_watch_documentrelation', 'relation_type')
