...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.published_by'
        db.add_column('big_projects_watch_comment', 'published_by',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'DocumentRelation.published_by'
        db.add_column('big_projects_watch_documentrelation', 'published_by',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.published_by'
        db.delete_column('big_projects_watch_comment', 'published_by')

        # Deleting field 'DocumentRelation.published_by'
        db.delete_column('big_projects_watch_documentrelation', 'published_by')
    ...
    models = {
        ...
        'big_projects_watch.documentrelation': {
            ...
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'published_by': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'relation_type': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
