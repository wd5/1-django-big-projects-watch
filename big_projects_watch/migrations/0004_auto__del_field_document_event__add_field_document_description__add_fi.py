...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.event'
        db.delete_column('big_projects_watch_document', 'event_id')

        # Adding field 'Document.description'
        db.add_column('big_projects_watch_document', 'description',
                      self.gf('django.db.models.fields.TextField')(default='Description'),
                      keep_default=False)

        # Adding field 'Document.comments'
        db.add_column('big_projects_watch_document', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Document.event'
        db.add_column('big_projects_watch_document', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['big_projects_watch.Event'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Document.description'
        db.delete_column('big_projects_watch_document', 'description')

        # Deleting field 'Document.comments'
        db.delete_column('big_projects_watch_document', 'comments')
