...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('big_projects_watch_question', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('big_projects_watch', ['Question'])

        # Adding M2M table for field project_parts on 'Question'
        db.create_table('big_projects_watch_question_project_parts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm['big_projects_watch.question'], null=False)),
            ('projectpart', models.ForeignKey(orm['big_projects_watch.projectpart'], null=False))
        ))
        db.create_unique('big_projects_watch_question_project_parts', ['question_id', 'projectpart_id'])

        # Adding M2M table for field participants on 'Question'
        db.create_table('big_projects_watch_question_participants', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm['big_projects_watch.question'], null=False)),
            ('participant', models.ForeignKey(orm['big_projects_watch.participant'], null=False))
        ))
        db.create_unique('big_projects_watch_question_participants', ['question_id', 'participant_id'])

        # Adding M2M table for field events on 'Question'
        db.create_table('big_projects_watch_question_events', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm['big_projects_watch.question'], null=False)),
            ('event', models.ForeignKey(orm['big_projects_watch.event'], null=False))
        ))
        db.create_unique('big_projects_watch_question_events', ['question_id', 'event_id'])


    def backwards(self, orm):
        # Deleting model 'Question'
        db.delete_table('big_projects_watch_question')

        # Removing M2M table for field project_parts on 'Question'
        db.delete_table('big_projects_watch_question_project_parts')

        # Removing M2M table for field participants on 'Question'
        db.delete_table('big_projects_watch_question_participants')

        # Removing M2M table for field events on 'Question'
        db.delete_table('big_projects_watch_question_events')
