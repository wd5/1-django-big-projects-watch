...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectPart.order'
        db.add_column('big_projects_watch_projectpart', 'order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'ProjectGoal.order'
        db.alter_column('big_projects_watch_projectgoal', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Adding field 'Comment.activation_hash'
        db.add_column('big_projects_watch_comment', 'activation_hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'DocumentRelation.activation_hash'
        db.add_column('big_projects_watch_documentrelation', 'activation_hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectPart.order'
        db.delete_column('big_projects_watch_projectpart', 'order')


        # Changing field 'ProjectGoal.order'
        db.alter_column('big_projects_watch_projectgoal', 'order', self.gf('django.db.models.fields.IntegerField')(default=100))
        # Deleting field 'Comment.activation_hash'
        db.delete_column('big_projects_watch_comment', 'activation_hash')

        # Deleting field 'DocumentRelation.activation_hash'
        db.delete_column('big_projects_watch_documentrelation', 'activation_hash')
