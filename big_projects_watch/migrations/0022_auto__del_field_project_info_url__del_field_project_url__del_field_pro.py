...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.info_url'
        db.delete_column('big_projects_watch_project', 'info_url')

        # Deleting field 'Project.url'
        db.delete_column('big_projects_watch_project', 'url')

        # Deleting field 'ProjectPart.url'
        db.delete_column('big_projects_watch_projectpart', 'url')

        # Deleting field 'Participant.info_url'
        db.delete_column('big_projects_watch_participant', 'info_url')

        # Deleting field 'Participant.url'
        db.delete_column('big_projects_watch_participant', 'url')


    def backwards(self, orm):
        # Adding field 'Project.info_url'
        db.add_column('big_projects_watch_project', 'info_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Project.url'
        raise RuntimeError("Cannot reverse this migration. 'Project.url' and its values cannot be restored.")
        # Adding field 'ProjectPart.url'
        db.add_column('big_projects_watch_projectpart', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Participant.info_url'
        db.add_column('big_projects_watch_participant', 'info_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Participant.url'
        raise RuntimeError("Cannot reverse this migration. 'Participant.url' and its values cannot be restored.")
