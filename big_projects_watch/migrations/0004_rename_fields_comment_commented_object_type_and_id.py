...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('big_projects_watch_comment', 'commented_object_type_id', 'content_type_id')
        db.rename_column('big_projects_watch_comment', 'commented_object_id', 'object_id')

    def backwards(self, orm):
        db.rename_column('big_projects_watch_comment', 'content_type_id', 'commented_object_type_id')
        db.rename_column('big_projects_watch_comment', 'object_id', 'commented_object_id')
