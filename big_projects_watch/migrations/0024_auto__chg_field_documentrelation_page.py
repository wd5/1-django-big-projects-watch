...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocumentRelation.page'
        db.alter_column('big_projects_watch_documentrelation', 'page', self.gf('django.db.models.fields.IntegerField')(default=1))

    def backwards(self, orm):

        # Changing field 'DocumentRelation.page'
        db.alter_column('big_projects_watch_documentrelation', 'page', self.gf('django.db.models.fields.IntegerField')(null=True))
