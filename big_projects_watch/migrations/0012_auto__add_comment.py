...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('big_projects_watch_comment', (
            ...
            ('passage_in_document', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
    ...
    models = {
        'big_projects_watch.comment': {
            ...
            'passage_in_document': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
