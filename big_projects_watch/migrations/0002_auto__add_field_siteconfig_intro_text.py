...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteConfig.intro_text'
        db.add_column('big_projects_watch_siteconfig', 'intro_text',
                      self.gf('django.db.models.fields.TextField')(default=u'This is a project watch website.'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteConfig.intro_text'
        db.delete_column('big_projects_watch_siteconfig', 'intro_text')
