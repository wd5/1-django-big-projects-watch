...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WebSource.event'
        db.delete_column('big_projects_watch_websource', 'event_id')


    def backwards(self, orm):
        # Adding field 'WebSource.event'
        db.add_column('big_projects_watch_websource', 'event',
