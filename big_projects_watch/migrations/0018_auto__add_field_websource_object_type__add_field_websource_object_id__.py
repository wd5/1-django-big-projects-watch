...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebSource.object_type'
        db.add_column('big_projects_watch_websource', 'object_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'WebSource.object_id'
        db.add_column('big_projects_watch_websource', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'WebSource.date'
        db.alter_column('big_projects_watch_websource', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting field 'WebSource.object_type'
        db.delete_column('big_projects_watch_websource', 'object_type_id')

        # Deleting field 'WebSource.object_id'
        db.delete_column('big_projects_watch_websource', 'object_id')


        # User chose to not deal with backwards NULL issues for 'WebSource.date'
        raise RuntimeError("Cannot reverse this migration. 'WebSource.date' and its values cannot be restored.")
