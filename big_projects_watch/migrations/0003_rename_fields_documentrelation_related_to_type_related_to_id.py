...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('big_projects_watch_documentrelation', 'related_to_type_id', 'content_type_id')
        db.rename_column('big_projects_watch_documentrelation', 'related_to_id', 'object_id')

    def backwards(self, orm):
        db.rename_column('big_projects_watch_documentrelation', 'content_type_id', 'related_to_type_id')
        db.rename_column('big_projects_watch_documentrelation', 'object_id', 'related_to_id')
