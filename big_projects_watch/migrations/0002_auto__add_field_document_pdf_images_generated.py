...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.pdf_images_generated'
        db.add_column('big_projects_watch_document', 'pdf_images_generated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.pdf_images_generated'
        db.delete_column('big_projects_watch_document', 'pdf_images_generated')
