...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('big_projects_watch_document', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['big_projects_watch.Participant'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.author'
        db.delete_column('big_projects_watch_document', 'author_id')
